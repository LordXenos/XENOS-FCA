...
- Added XENOS credits to main entry points (index.js, core.js, utils.js)
...
### Critical Bug Fixes
1. **MQTT Error Handler Crash** - Fixed undefined reference to `api.xenos.relogin()` that caused crashes on disconnect
...
### Branding Cleanup
- Removed all contributor names except XENOS from source code
- Removed references to ws3-fca in code (kept as inspiration credit in README)
- Standardized all branding to XENOS across the library
...
**Author**: XENOS (https://github.com/LordXenos)  
